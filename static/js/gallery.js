...
export function openGallery() {
  ...
  function _showGalleryBulkMenu(anchor) {
    ...
    dropdown.style.cssText = `position:fixed;display:block;z-index:${topPortalZ()};top:${(rect.bottom + 6) / _zr}px;left:${Math.max(8, left) / _zr}px;right:auto;min-width:180px;background:var(--panel,var(--bg));border:1px solid var(--border);border-radius:10px;box-shadow:0 8px 24px rgba(0,0,0,0.3);padding:6px;font-size:11px;`;
